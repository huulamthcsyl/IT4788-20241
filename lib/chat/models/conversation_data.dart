...
ConversationData conversationDataFromJson(String str) => ConversationData.fromJson(json.decode(str));

String conversationDataToJson(ConversationData data) => json.encode(data.toJson());
...
class ConversationData {
  ...
  factory ConversationData.fromJson(Map<String, dynamic> json) => ConversationData(
    id: json["id"],
    partner: SenderData.fromJson(json["partner"]),
