...
return Scaffold(
appBar: AppBar(backgroundColor: Colors.red, automaticallyImplyLeading: false, centerTitle: true, title: Center(child: Text("TÌM KIẾM NGƯỜI DÙNG", style: TextStyle(color: Colors.white, fontSize: 20)))),
body: Column(
  children: [
  Padding(
