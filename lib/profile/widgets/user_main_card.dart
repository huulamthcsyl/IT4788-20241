                    ...
                    children: [
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: _profileviewmodel.userData.avatar !=
                                      null &&
                                      _profileviewmodel
                                          .userData.avatar!.isNotEmpty
                                      ? NetworkImage(_profileviewmodel
                                      .convertGoogleDriveLink(
                                      _profileviewmodel.userData.avatar!)) as ImageProvider
                                      : AssetImage(
                                      'assets/img/profile_wallpaper.jpg'),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(_profileviewmodel.userData.name,
                                style: TextStyle(
                            ...
                            Text.rich(
                              TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                      text: _profileviewmodel.userData.email,
                                      style: TextStyle(
                                          fontSize: 14,
